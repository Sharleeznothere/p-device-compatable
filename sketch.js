...
function createCash() {
  if (World.frameCount % 200 == 0) {
   ...
   cashGroup=createGroup(width/2,height-20,20,20)
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
       ...
       DimondGroup=createGroup(width/2,height-20,20,20)
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    JewlleryGroup=createGroup(width/2,height-20,20,20)
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    swordGroup=createGroup(width/2,height-20,20,20)
